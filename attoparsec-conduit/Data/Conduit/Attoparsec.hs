...
--
-- Since 0.5.0
sinkParser :: (AttoparsecInput a, MonadThrow m) => A.Parser a b -> Sink a m b
...
sinkParserPos :: (AttoparsecInput a, MonadThrow m) => Position -> A.Parser a b -> Sink a m (Position, b)
sinkParserPos pos0 =
